...
public class AddDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null) {
            ...
            toolbar.setTitle("Editeaza doctor");
    ...
    public void AddToFirestore(String id,String nume1,String prenume1,String telefon1,String email1,String specializare1,String parola1)
    {
    ...
    public void UpdateToFireStore(String id,String nume1,String prenume1,String telefon1,String email1,String specializare1)
    {
    ...
    public void readId(String email, AddDoctor.FirestoreCallback firestoreCallback)
    {
